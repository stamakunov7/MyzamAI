...
legalbot/
├── core/
│   ├── llm_manager.py           # Centralized Llama 3 instance
│   ├── build_faiss_index.py     # FAISS index builder
│   ├── law_retriever.py         # Document retrieval
│   └── agents/
│       ├── legal_expert.py      # Legal interpretation (Llama 3)
│       ├── summarizer.py        # Text summarization (Llama 3)
│       ├── translator.py        # RU↔EN translation
│       ├── reviewer_agent.py    # Quality control (Llama 3)
